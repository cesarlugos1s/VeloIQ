"""safem search — manage which models appear in the global search bar."""
...
def add_model(model_name: str, fields: str | None) -> None:
    ...
    if fields:
        ...
        click.echo(
            ...
            "     Example:  safem search add-field title"
        )
...
def add_field(field_name: str) -> None:
    ...
    \b
    Example:
      safem search add-field name
      safem search add-field description
    """
    data = _load()
