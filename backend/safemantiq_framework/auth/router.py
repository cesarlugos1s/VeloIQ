...
from safemantiq_framework.auth.models import (
    Role, Tenant, User,
    user_has_role_link,
    user_has_tenant_link,
)
from safemantiq_framework.auth.utils import (
    check_rbac,
    create_access_token,
    get_current_user,
    hash_password,
...
def make_auth_router(cfg) -> APIRouter:
    ...
    *cfg* is a :class:`~safemantiq_framework.config.SafemConfig` instance
