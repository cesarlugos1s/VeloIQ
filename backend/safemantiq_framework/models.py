...
Import these in your module models::
    ...
    from safemantiq_framework import FrameworkModel, TimestampedModel
...
class FrameworkModel(SQLModel):
    """Minimal base model for SafeMantIQ framework apps.
...
class StandardModel(SQLModel):
    ...
    SQLAlchemy and the SafeMantIQ framework both use the Python name ``eid``
