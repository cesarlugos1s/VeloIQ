...
var DynamicCreate = ({ model: modelProp, allModels, journeyCallbacks, injectedValues }) => {
  ...
  const renderSectionGrid = (section, rows, useReadonly) => {
    ...
    return /* @__PURE__ */ jsxs("div", { style: { border: `1px solid ${token.colorBorder}`, borderRadius: 8, padding: "6px 6px", marginBottom: 6 }, children: [
      ...
      /* @__PURE__ */ jsx("table", { style: { width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }, children: /* @__PURE__ */ jsx("tbody", { children: Array.from({ length: maxRow }).map((_40, rowIdx) => /* @__PURE__ */ jsx("tr", { children: Array.from({ length: maxCol }).map((_41, colIdx) => {
                  ...
                  return /* @__PURE__ */ jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("table", { style: { width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }, children: /* @__PURE__ */ jsx("tbody", { children: Array.from({ length: maxRow }).map((_40, rowIndex) => /* @__PURE__ */ jsx("tr", { children: Array.from({ length: maxCol }).map((_41, colIndex) => {
    ...
    const tabChildren = /* @__PURE__ */ jsx(Form, { ...editFormProps, size: "small", style: { position: "relative" }, children: Array.from(gridRowMap.keys()).sort((a, b) => a - b).map((gridRow) => {
      ...
      return /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: 6, alignItems: "flex-start", marginBottom: 6 }, children: rowSections.map(({ name: section, rows }) => {
        ...
        return /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0, border: `1px solid ${token.colorBorder}`, borderRadius: 8, padding: "2px 6px" }, children: [
          /* @__PURE__ */ jsx(Title3, { level: 5, style: { margin: 0, color: "#1677ff" }, children: _24(section) }),
          /* @__PURE__ */ jsx("table", { style: { width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }, children: /* @__PURE__ */ jsx("tbody", { children: Array.from({ length: maxRow }).map((_40, ri) => /* @__PURE__ */ jsx("tr", { children: Array.from({ length: maxCol }).map((_41, ci) => {
...
var ReadAndEditReference = ({ value, onChange, field, allModels, model, currentId }) => {
  ...
  if (editing) {
    return /* @__PURE__ */ jsxs(Space, { size: 4, style: { width: "100%" }, children: [
      ...
      /* @__PURE__ */ jsx(Button, { size: "small", type: "primary", icon: /* @__PURE__ */ jsx(CheckOutlined, {}), onClick: handleConfirm }),
      /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(CloseOutlined, {}), onClick: handleCancel })
    ] });
  }
  if (!value) {
    return /* @__PURE__ */ jsxs(Space, { size: 4, children: [
      /* @__PURE__ */ jsx("span", { style: { color: "inherit" }, children: "-" }),
      /* @__PURE__ */ jsx(Button, { size: "small", type: "text", icon: /* @__PURE__ */ jsx(EditOutlined, {}), onClick: handleEdit, style: { padding: "0 2px", height: "auto" } })
    ] });
  }
  return /* @__PURE__ */ jsxs(Space, { size: 4, children: [
...
var RelatedObjectsEditableCsv = ({ rel, record, allModels }) => {
  ...
  if (error) return /* @__PURE__ */ jsx(Alert, { type: "error", message: error, showIcon: true });
  if (!rel.otherResource || !rel.otherKey) {
    return /* @__PURE__ */ jsx(Alert, { type: "warning", message: _30("editable-csv requires a many-to-many relation"), showIcon: true });
  }
  return /* @__PURE__ */ jsx(
    Select,
    {
...
var RelatedObjectsTable = ({ rel, record, relatedModel, parentModel, showActions = false, showCreate = false, title, allowInlineEdit = false, allowedRelatedIds, allModels, layoutPreferenceType, viewVariant = "default" }) => {
  ...
  const persistLayoutPreferences = useCallback(async (viewName) => {
    ...
    try {
      ...
      message.success(_31("Layout preferences saved."));
    } catch (error2) {
      message.error(error2 instanceof Error ? error2.message : _31("Failed to save layout preferences."));
    } finally {
  ...
  const persistAnalyzePreferences = useCallback(async (viewName) => {
    ...
    try {
      ...
      message.success(_31("Analyze preferences saved."));
    } catch (error2) {
      message.error(error2 instanceof Error ? error2.message : _31("Failed to save analyze preferences."));
    } finally {
  ...
  const handleConfirmSaveView = useCallback(async () => {
    ...
    if (saveViewAsNew && viewExists) {
      message.error(_31("View name already exists. Choose a new name."));
      return;
    }
    if (!saveViewAsNew && viewName !== currentViewName && viewExists) {
      message.error(_31('Choose a new name or enable "Save as new view".'));
      return;
    }
  ...
  const handleRenameView = useCallback(async () => {
    ...
    if (availableViewNames.includes(newName)) {
      message.error(_31("View name already exists."));
      return;
    }
    try {
      const resourceKey = resolveResourcePath(relatedModel.resource || relatedModel.name, allModels);
      ...
      message.success(_31("View renamed."));
      setRenameViewModalOpen(false);
      await loadViewNames();
    } catch (error2) {
      message.error(error2 instanceof Error ? error2.message : _31("Failed to rename view."));
    }
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          ...
          message.success(_31("View deleted."));
          await loadViewNames();
        } catch (error2) {
          message.error(error2 instanceof Error ? error2.message : _31("Failed to delete view."));
        }
      }
    });
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          ...
          message.success(_31("Relation deleted."));
        } catch (err) {
          message.error(err instanceof Error ? err.message : _31("Failed to delete relation."));
        }
      }
    });
  ...
  const renderTotalsBoxes = (keyPrefix = "") => {
    ...
    return /* @__PURE__ */ jsxs("div", { style: { marginBottom: 12, borderRadius: 8, padding: 10, background: token.colorBgContainer }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        ...
        /* @__PURE__ */ jsx(Tooltip, { title: isTotalsDetailsFlipped ? _31("Show totals") : _31("Show details"), children: /* @__PURE__ */ jsx(
          Button,
          {
            size: "small",
      ...
      relationRowsCapped && /* @__PURE__ */ jsxs("div", { style: { marginTop: 8, display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ jsx(Typography.Text, { type: "secondary", style: { fontSize: 12 }, children: _31("Only the first N rows are loaded").replace("N", formatNumberValue(loadedRowsCount || relationsMaxRowsToLoad)) }),
        /* @__PURE__ */ jsx(
          Button,
          {
            size: "small",
  ...
  return /* @__PURE__ */ jsxs("div", { className: "jm-tone-scope", style: toneScopeStyle(relatedModelTone), children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 8 }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8 }, children: [
        /* @__PURE__ */ jsx(Tooltip, { title: columnsSelectorOpen ? _31("Hide view configuration") : _31("Show view configuration"), children: /* @__PURE__ */ jsx(
          Button,
          {
            size: "small",
        ...
        showCreate && recordId !== void 0 && recordId !== null && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Tooltip, { title: rel.otherResource && rel.otherKey ? _31("Associate existing") : _31("Add relation"), children: /* @__PURE__ */ jsx(
            Button,
            {
              size: "small",
          ...
          rel.otherResource && rel.otherKey && rel.targetKey && /* @__PURE__ */ jsx(Tooltip, { title: _31("Create new and relate"), children: /* @__PURE__ */ jsx(
            Button,
            {
              size: "small",
        ...
        allowInlineEdit && /* @__PURE__ */ jsx(Tooltip, { title: _31("Save"), children: /* @__PURE__ */ jsx(
          Button,
          {
            size: "small",
            type: "primary",
        ...
        /* @__PURE__ */ jsx(Tooltip, { title: _31("Export CSV"), children: /* @__PURE__ */ jsx(
          Button,
          {
            size: "small",
      ...
      Modal,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 12 }, children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("View name") }),
            /* @__PURE__ */ jsx(Input, { value: saveViewName, onChange: (event) => setSaveViewName(event.target.value) })
          ] }),
          /* @__PURE__ */ jsx(Checkbox, { checked: saveViewAsNew, onChange: (event) => setSaveViewAsNew(event.target.checked), children: _31("Save as new view") })
        ] })
      }
    ),
    /* @__PURE__ */ jsx(
    ...
    !filtersCollapsed && /* @__PURE__ */ jsx(
      Card,
      {
        ...
        title: /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }, children: [
          /* @__PURE__ */ jsx("span", { style: { color: token.colorTextSecondary, fontSize: 12, fontWeight: 600 }, children: _31("Filters") }),
    ...
    columnsSelectorOpen && /* @__PURE__ */ jsxs(
      ...
      {
        size: "small",
        title: /* @__PURE__ */ jsx("span", { style: { color: token.colorTextSecondary, fontSize: 12, fontWeight: 600 }, children: _31("View configuration") }),
        style: { marginBottom: 16 },
        styles: { body: { display: "grid", gap: 12 } },
        children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 12 }, children: [
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 8 }, children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, fontWeight: 600 }, children: _31("Advanced filters") }),
              filterRules.length === 0 ? /* @__PURE__ */ jsx("div", { style: { color: token.colorTextSecondary, fontSize: 12 }, children: _31("No filters yet.") }) : filterRules.map((rule) => {
                const field = relatedModel.fields.find((f) => f.key === rule.fieldKey);
              ...
              /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8 }, children: [
                ...
                filterRules.length > 0 && /* @__PURE__ */ jsx(Button, { size: "small", onClick: () => setFilterRules([]), children: _31("Clear filters") })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 6 }, children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, fontWeight: 600 }, children: _31("Views shown") }),
              /* @__PURE__ */ jsx(
                Select,
                {
                  mode: "multiple",
              ...
              selectedViewNames.length > 1 && /* @__PURE__ */ jsx("div", { style: { display: "grid", gap: 6 }, children: selectedViewNames.map((name, index) => /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
                ...
                /* @__PURE__ */ jsx(Tooltip, { title: _31("Move up"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(ArrowUpOutlined, {}), disabled: index === 0, onClick: () => moveSelectedView(name, "up") }) }),
                /* @__PURE__ */ jsx(Tooltip, { title: _31("Move down"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(ArrowDownOutlined, {}), disabled: index === selectedViewNames.length - 1, onClick: () => moveSelectedView(name, "down") }) })
              ] }, name)) })
            ] }),
            /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 6 }, children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, fontWeight: 600 }, children: _31("Active view") }),
              viewSelector
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 12 }, children: [
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }, children: [
              /* @__PURE__ */ jsx("span", { style: { color: token.colorTextSecondary, fontSize: 12, fontWeight: 600 }, children: _31("Columns") }),
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 6 }, children: _31("Select columns") }),
              /* @__PURE__ */ jsx(
                Checkbox.Group,
                {
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 6 }, children: _31("Column order") }),
              orderedSelectedColumns.length === 0 ? /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary }, children: _31("No custom order yet.") }) : orderedSelectedColumns.map((key, index) => {
                ...
                return /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }, children: [
                  ...
                  /* @__PURE__ */ jsx(Tooltip, { title: _31("Move left"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(ArrowLeftOutlined, {}), disabled: index === 0, onClick: () => moveColumnOrder(key, "left") }) }),
                  /* @__PURE__ */ jsx(Tooltip, { title: _31("Move right"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(ArrowRightOutlined, {}), disabled: index === orderedSelectedColumns.length - 1, onClick: () => moveColumnOrder(key, "right") }) })
                ] }, key);
              })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 6 }, children: _31("Totals summary function") }),
              /* @__PURE__ */ jsx("div", { style: { display: "grid", gap: 6 }, children: totalsSummaryConfigFields.length === 0 ? /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary }, children: _31("No numeric fields available.") }) : totalsSummaryConfigFields.map((field) => {
                const options = [
    ...
    /* @__PURE__ */ jsxs("div", { style: listAnalyzeLayoutStyle, children: [
            ...
            Form,
            {
              ...
              children: /* @__PURE__ */ jsxs(
                Table,
                {
                  ...
                  locale: filteredRows.length === 0 ? { emptyText: /* @__PURE__ */ jsx("span", { style: { display: "inline-block", fontSize: 12, color: "#8c8c8c" }, children: _31("No related records") }) } : void 0,
                        ...
                        render: (_unused, row) => {
                          ...
                          return /* @__PURE__ */ jsxs(Space, { children: [
                            id && /* @__PURE__ */ jsxs(Fragment, { children: [
                              /* @__PURE__ */ jsx(Tooltip, { title: _31("View"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(EyeOutlined, {}), onClick: () => {
                                if (paneNav?.isInMultiPane) {
                                  paneNav.openDetail(relatedModel.name, id);
                                } else {
                                  go({ to: { resource: relatedModel.name, action: "show", id } });
                              ...
                              /* @__PURE__ */ jsx(Tooltip, { title: _31("Edit"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(EditOutlined, {}), onClick: () => {
                                if (allowInlineEdit) {
                                  const params = new URLSearchParams();
                            ...
                            deleteId && /* @__PURE__ */ jsx(Tooltip, { title: _31("Delete"), children: /* @__PURE__ */ jsx(
                              Button,
                              {
                                size: "small",
                                danger: true,
      ...
      analyzeOpen && filteredRows.length > 0 && analyzePrefsReady && /* @__PURE__ */ jsx("div", { style: analyzeContainerStyle, children: /* @__PURE__ */ jsx(
        ...
        {
          size: "small",
          title: /* @__PURE__ */ jsx("span", { style: { color: relatedModelTone.text, fontWeight: 600 }, children: _31("Analyze") }),
          styles: {
            header: {
              ...
              children: [
                  ...
                  Card,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { style: { position: "absolute", top: 0, right: 0, display: "flex", gap: 8 }, children: [
                        /* @__PURE__ */ jsx(Tooltip, { title: _31("Save preferences"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(SaveOutlined, {}), onClick: () => openSaveViewModalFor("analyze"), loading: isSavingAnalyzePrefs }) }),
                        /* @__PURE__ */ jsx(Tooltip, { title: _31("Stats"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(FileTextOutlined, {}), onClick: () => setIsStatsFlipped(true) }) }),
                        /* @__PURE__ */ jsx(Tooltip, { title: _31("Export chart PDF"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(FilePdfOutlined, {}), onClick: exportChartPdf }) }),
                        /* @__PURE__ */ jsx(Tooltip, { title: _31("Export chart PNG"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(DownloadOutlined, {}), onClick: exportChartImage, "aria-label": _31("Export chart") }) })
                      ] }),
                      /* @__PURE__ */ jsx(
                        AnalysisChart,
                        {
                              ...
                              children: /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 16 }, children: [
                                /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 16, flexWrap: "wrap" }, children: [
                                  /* @__PURE__ */ jsxs("div", { style: { minWidth: 220, flex: 1 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("Category 1") }),
                                    /* @__PURE__ */ jsx(
                                      Select,
                                      {
                                  ...
                                  /* @__PURE__ */ jsxs("div", { style: { minWidth: 220, flex: 1 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("Category 2") }),
                                    /* @__PURE__ */ jsx(
                                      Select,
                                      {
                                  ...
                                  /* @__PURE__ */ jsxs("div", { style: { minWidth: 160 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("Chart Type") }),
                                    /* @__PURE__ */ jsx(
                                      Select,
                                      {
                                        value: chartType,
                                  ...
                                  /* @__PURE__ */ jsxs("div", { style: { minWidth: 200 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("Summary") }),
                                    /* @__PURE__ */ jsx(
                                      Select,
                                      {
                                        value: summaryFn,
                                  ...
                                  /* @__PURE__ */ jsxs("div", { style: { minWidth: 180 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("Ranking Filter") }),
                                    /* @__PURE__ */ jsx(
                                      Select,
                                      {
                                        value: rankingMode,
                                  ...
                                  /* @__PURE__ */ jsxs("div", { style: { minWidth: 220 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("Ranking Column") }),
                                    /* @__PURE__ */ jsx(
                                      Select,
                                      {
                                  ...
                                  /* @__PURE__ */ jsxs("div", { style: { minWidth: 120 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary, marginBottom: 4 }, children: _31("N") }),
                                    /* @__PURE__ */ jsx(
                                      InputNumber,
                                      {
                                        min: 1,
                                ...
                                /* @__PURE__ */ jsxs("div", { children: [
                                  /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 6 }, children: [
                                    /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: token.colorTextSecondary }, children: _31("Series") }),
                                    /* @__PURE__ */ jsx(Tooltip, { title: _31("Unselect All"), children: /* @__PURE__ */ jsx(
                                      Button,
                                      {
                                        size: "small",
                ...
                /* @__PURE__ */ jsxs(
                  Card,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { style: { position: "absolute", top: 0, right: 0, display: "flex", gap: 8 }, children: [
                        /* @__PURE__ */ jsx(Tooltip, { title: _31("Analysis"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(BarChartOutlined, {}), onClick: () => setIsStatsFlipped(false) }) }),
                        /* @__PURE__ */ jsx(Tooltip, { title: _31("Export stats PDF"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(FilePdfOutlined, {}), onClick: exportStatsPdf }) })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 16 }, children: [
                        statsSummary.numericStats.length > 0 && /* @__PURE__ */ jsx(Card, { size: "small", title: /* @__PURE__ */ jsx("span", { style: statsTitleStyle, children: _31("Numeric columns") }), children: /* @__PURE__ */ jsxs(
                          Table,
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsx(Table.Column, { title: _31("Sum"), align: "right", render: (_unused, row) => renderStatBar(row.sum, statsNumericMaxes.sum, formatNumberValue), onHeaderCell: () => ({ style: statsHeaderStyle }) }, "sum"),
                              /* @__PURE__ */ jsx(Table.Column, { title: _31("Average"), align: "right", render: (_unused, row) => renderStatBar(row.avg, statsNumericMaxes.avg, formatNumberValue), onHeaderCell: () => ({ style: statsHeaderStyle }) }, "avg"),
                              /* @__PURE__ */ jsx(Table.Column, { title: _31("Min"), align: "right", render: (_unused, row) => renderStatBar(row.min, statsNumericMaxes.min, formatNumberValue), onHeaderCell: () => ({ style: statsHeaderStyle }) }, "min"),
                              /* @__PURE__ */ jsx(Table.Column, { title: _31("Max"), align: "right", render: (_unused, row) => renderStatBar(row.max, statsNumericMaxes.max, formatNumberValue), onHeaderCell: () => ({ style: statsHeaderStyle }) }, "max"),
                              /* @__PURE__ */ jsx(Table.Column, { title: _31("Std Dev"), align: "right", render: (_unused, row) => renderStatBar(row.stddev, statsNumericMaxes.stddev, formatNumberValue), onHeaderCell: () => ({ style: statsHeaderStyle }) }, "stddev")
                            ]
                          }
                        ) }),
                            ...
                            items: [
                              {
                                ...
                                label: /* @__PURE__ */ jsx("span", { style: statsTitleStyle, children: _31("Categorical columns (distinct < 20)") }),
                                children: statsSummary.categoricalStats.map((field) => /* @__PURE__ */ jsxs("div", { style: { marginBottom: 12 }, children: [
                                  ...
                                  /* @__PURE__ */ jsxs(
                                    Table,
                                    {
                                      ...
                                      children: [
                                        /* @__PURE__ */ jsx(Table.Column, { title: _31("Value"), dataIndex: "value", onHeaderCell: () => ({ style: statsHeaderStyle }) }, "value"),
                                        /* @__PURE__ */ jsx(
                                          Table.Column,
                                          {
                                            title: _31("Count"),
...
var DetailPaneContent = ({ node, allModels }) => {
  ...
  if (!model) {
    return /* @__PURE__ */ jsx(Empty, { description: `${_32("No schema for")} ${node.resource}`, style: { marginTop: 32 } });
  }
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }, children: [
      ...
      showHref && /* @__PURE__ */ jsx(Tooltip, { title: _32("Open in new tab"), children: /* @__PURE__ */ jsx(
        Button,
        {
          size: "small",
...
var MillerBrowserLayout = ({
  ...
  if (!rootId) {
    return /* @__PURE__ */ jsx(Empty, { description: _32("No record selected") });
  }
...
var DynamicList = ({ model: modelProp, allModels, filter, relationConfig, isEmbedded = false, showActions = true, showCreate = true, layoutPreferenceType, listViewType, rowSelection, extraHeaderButtons, bulkActions, preferencesResourceOverride, defaultListVisible }) => {
  ...
  const handleRenameView = useCallback(async () => {
    ...
    try {
      ...
      message.error(error instanceof Error ? error.message : _33("Failed to rename view."));
    }
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          ...
          message.error(error instanceof Error ? error.message : _33("Failed to delete view."));
        }
      }
    });
  ...
  const persistLayoutPreferences = useCallback(async (viewName) => {
    ...
    try {
      ...
      message.error(error instanceof Error ? error.message : _33("Failed to save layout preferences."));
    } finally {
      setIsSavingLayoutPrefs(false);
    }
  ...
  const persistAnalyzePreferences = useCallback(async (viewName) => {
    ...
    try {
      ...
      message.error(error instanceof Error ? error.message : _33("Failed to save analyze preferences."));
    } finally {
      setIsSavingAnalyzePrefs(false);
    }
  ...
  const renderDynamicListTotalsBoxes = () => {
    ...
    return /* @__PURE__ */ jsx("div", { style: { marginBottom: 12, borderRadius: 8, padding: 10, background: token.colorBgContainer }, children: /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
      ...
      /* @__PURE__ */ jsx(Tooltip, { title: isTdFlipped ? _33("Show totals") : _33("Show details"), children: /* @__PURE__ */ jsx(
        Button,
        {
          size: "small",
          icon: /* @__PURE__ */ jsx(SwapOutlined, { style: { transform: "rotate(90deg)" } }),
  ...
  const executeBulkActions = useCallback(async () => {
    ...
    try {
      ...
      errorOccurred = true;
      message.error(e?.message || _33("Bulk action failed"));
    } finally {
  ...
  const selectModeBanner = selectMode ? /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsx("span", { style: { fontWeight: 500, color: token.colorWarningText }, children: bulkSelectedRowKeys.length > 0 ? _33("{count} rows selected").replace("{count}", String(bulkSelectedRowKeys.length)) : _33("Select rows to associate") }),
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8 }, children: [
      selectModeReturnTo && /* @__PURE__ */ jsx(Button, { size: "small", onClick: () => navigate(selectModeReturnTo), children: _33("Cancel") }),
      /* @__PURE__ */ jsx(
        Button,
        {
          size: "small",
  ...
  const bulkActionsToolbar = !isGalleryView && !isCalendarView && bulkSelectedRowKeys.length > 0 ? /* @__PURE__ */ jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsx("span", { style: { fontWeight: 500 }, children: _33("{count} rows selected").replace("{count}", String(bulkSelectedRowKeys.length)) }),
    ...
    /* @__PURE__ */ jsx(Button, { type: "link", size: "small", onClick: clearBulkSelection, style: { padding: 0 }, children: _33("Clear selection") }),
  ...
  const bulkConfirmationModal = /* @__PURE__ */ jsxs(
    Modal,
    {
      ...
      footer: [
        /* @__PURE__ */ jsx(Button, { onClick: () => setBulkActionModalOpen(false), disabled: isBulkExecuting, children: _33("Cancel") }, "cancel"),
        /* @__PURE__ */ jsx(Button, { type: "primary", loading: isBulkExecuting, onClick: executeBulkActions, children: _33("Confirm") }, "ok")
      ],
      children: [
        /* @__PURE__ */ jsx("p", { children: _33("You are about to apply the following actions to {count} rows:").replace("{count}", String(bulkSelectedRowKeys.length)) }),
  ...
  const listToggleButton = /* @__PURE__ */ jsx(Tooltip, { title: _33("View list"), children: /* @__PURE__ */ jsx(
    Button,
    {
      size: "small",
      icon: /* @__PURE__ */ jsx(UnorderedListOutlined, {}),
  ...
  const exportButton = !isEmbedded ? /* @__PURE__ */ jsx(Tooltip, { title: _33("Export CSV"), children: /* @__PURE__ */ jsx(
    Button,
    {
      size: "small",
      icon: /* @__PURE__ */ jsx(DownloadOutlined, {}),
  ...
  const columnsToggleButton = /* @__PURE__ */ jsx(Tooltip, { title: columnsSelectorOpen ? _33("Hide view configuration") : _33("Show view configuration"), children: /* @__PURE__ */ jsx(
    Button,
    {
      size: "small",
      icon: /* @__PURE__ */ jsx(SettingOutlined, {}),
  ...
  const createRelationButton = isRelationView && showCreate ? /* @__PURE__ */ jsx(Tooltip, { title: _33("Add relation"), children: /* @__PURE__ */ jsx(
    Button,
    {
      size: "small",
      icon: /* @__PURE__ */ jsx(PlusOutlined, {}),
  ...
  const associateExistingFkButton = isRelationView && showCreate && filter?.field && filter?.value !== void 0 && filter?.value !== null && !relationConfig?.otherKey ? /* @__PURE__ */ jsx(Tooltip, { title: _33("Associate existing"), children: /* @__PURE__ */ jsx(
    Button,
    {
      size: "small",
      icon: /* @__PURE__ */ jsx(LinkOutlined, {}),
  ...
  const createNewAndRelateButton = isRelationView && showCreate && relationConfig?.otherResource && relationConfig?.otherKey && (relationConfig?.targetKey || filter?.field) && filter?.value !== void 0 && filter?.value !== null ? /* @__PURE__ */ jsx(Tooltip, { title: _33("Create new and relate"), children: /* @__PURE__ */ jsx(
    Button,
    {
      size: "small",
      icon: /* @__PURE__ */ jsx(ShareAltOutlined, {}),
  ...
  const embeddedActionBar = isEmbedded ? /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8, marginBottom: 8 }, children: [
    columnsToggleButton,
    listToggleButton,
    /* @__PURE__ */ jsx(Tooltip, { title: _33("Analyze"), children: /* @__PURE__ */ jsx(
      Button,
      {
        size: "small",
        icon: /* @__PURE__ */ jsx(BarChartOutlined, {}),
    ...
    /* @__PURE__ */ jsx(Tooltip, { title: _33("Switch orientation"), children: /* @__PURE__ */ jsx(
      Button,
      {
        size: "small",
        icon: /* @__PURE__ */ jsx(ColumnHeightOutlined, {}),
    ...
    /* @__PURE__ */ jsx(Tooltip, { title: _33("Switch positions"), children: /* @__PURE__ */ jsx(
      Button,
      {
        size: "small",
        icon: /* @__PURE__ */ jsx(SwapOutlined, {}),
    ...
    resolvedLayoutPreferenceType && /* @__PURE__ */ jsx(Tooltip, { title: _33("Save layout"), children: /* @__PURE__ */ jsx(
      Button,
      {
        size: "small",
        icon: /* @__PURE__ */ jsx(SaveOutlined, {}),
  ...
  const renderCalendarView = () => {
    if (calendarDateFieldOptions.length === 0) {
      return /* @__PURE__ */ jsx(Empty, { description: _33("No date/datetime fields available for calendar view.") });
    }
    ...
    return /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 12 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 8 }, children: [
        ...
        /* @__PURE__ */ jsxs(Space, { size: 8, children: [
          /* @__PURE__ */ jsx(Tooltip, { title: _33("Previous"), children: /* @__PURE__ */ jsx(
            Button,
            {
              size: "small",
              icon: /* @__PURE__ */ jsx(ArrowLeftOutlined, {}),
          ...
          /* @__PURE__ */ jsx(Tooltip, { title: _33("Today"), children: /* @__PURE__ */ jsx(
            Button,
            {
              size: "small",
              icon: /* @__PURE__ */ jsx(CalendarOutlined, {}),
          ...
          /* @__PURE__ */ jsx(Tooltip, { title: _33("Next"), children: /* @__PURE__ */ jsx(
            Button,
            {
              size: "small",
              icon: /* @__PURE__ */ jsx(ArrowRightOutlined, {}),
  ...
  const listContent = /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        title: /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }, children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "center", gap: 8, flex: 1, justifyContent: "flex-end" }, children: !filtersCollapsed && searchField && /* @__PURE__ */ jsx(
            Form,
            {
              ...
              children: /* @__PURE__ */ jsx(Form.Item, { name: "q", style: { marginBottom: 0, width: "100%" }, children: /* @__PURE__ */ jsx(Input, { placeholder: _33("Search all fields..."), prefix: /* @__PURE__ */ jsx(SearchOutlined, {}), allowClear: true, style: { width: "100%" } }) })
            }
          ) })
        ] }),
        style: { marginBottom: 16 },
    ...
    /* @__PURE__ */ jsxs("div", { style: listAnalyzeLayoutStyle, children: [
              ...
              showActions && /* @__PURE__ */ jsx(
                Table.Column,
                {
                  ...
                  render: (_unused, record) => {
                    ...
                    if (!id || !resource) return /* @__PURE__ */ jsx(Tooltip, { title: `${_33("Debug: Cannot find target")}. ID: ${id}, Resource: ${resource}. Keys: ${Object.keys(record).join(",")}`, children: /* @__PURE__ */ jsx(Button, { size: "small", danger: true, icon: /* @__PURE__ */ jsx(BugOutlined, {}) }) });
                    ...
                    return /* @__PURE__ */ jsxs(Space, { children: [
                      /* @__PURE__ */ jsx(Tooltip, { title: _33("View"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(EyeOutlined, {}), onClick: () => go({ to: { resource, action: "show", id } }) }) }),
                      /* @__PURE__ */ jsx(Tooltip, { title: _33("Edit"), children: /* @__PURE__ */ jsx(Button, { size: "small", icon: /* @__PURE__ */ jsx(EditOutlined, {}), onClick: () => go({ to: { resource, action: "edit", id } }) }) }),
                      /* @__PURE__ */ jsx(Tooltip, { title: _33("Delete"), children: /* @__PURE__ */ jsx(DeleteButton, { hideText: true, size: "small", recordItemId: deleteId, resource: deleteResource }) })
                    ] });
                  }
                },
                "actions"
      ...
      analyzeOpen && !isEmptyTable && analyzePrefsReady && /* @__PURE__ */ jsx("div", { style: analyzeContainerStyle, children: /* @__PURE__ */ jsx(
        ...
        {
          size: "small",
          title: /* @__PURE__ */ jsx("span", { style: { color: modelTone.text, fontWeight: 600 }, children: _33("Analyze") }),
          styles: {
            header: {
                          ...
                          items: [
                            {
                              ...
                              children: /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: 16 }, children: [
                                ...
                                isAllRowsLoading && /* @__PURE__ */ jsx("div", { style: { color: token.colorTextSecondary, fontSize: 12 }, children: _33("Loading all rows for analysis...") }),
...
var PaneToolbar = ({ model, pane, allModels, onClose, onMinimize, onMaximize }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Tooltip, { title: _34("Open in full page"), children: /* @__PURE__ */ jsx(
          "a",
          {
            href,
            target: "_blank",
        ...
        /* @__PURE__ */ jsx(Tooltip, { title: _34("Minimize pane"), children: /* @__PURE__ */ jsx(
          Button,
          {
            type: "text",
            size: "small",
        ...
        /* @__PURE__ */ jsx(Tooltip, { title: _34("Maximize pane"), children: /* @__PURE__ */ jsx(
          Button,
          {
            type: "text",
            size: "small",
        ...
        /* @__PURE__ */ jsx(Tooltip, { title: _34("Close pane"), children: /* @__PURE__ */ jsx(
          Button,
          {
            type: "text",
            size: "small",
...
var HierarchyView = ({ resource, recordId, fallback }) => {
  ...
  if (ancestorsError || descendantsError) {
    ...
    return /* @__PURE__ */ jsx(Alert, { message: _35("Error loading hierarchy data"), type: "error" });
  }
  return /* @__PURE__ */ jsxs("div", { children: [
    ancestorsList.length > 0 && /* @__PURE__ */ jsxs("div", { style: { marginBottom: 24 }, children: [
      /* @__PURE__ */ jsx(Title8, { level: 5, children: _35("Parent Hierarchy") }),
    ...
    treeData.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(Title8, { level: 5, children: _35("Sub-hierarchy") }),
      /* @__PURE__ */ jsx(
        Tree,
        {
          showLine: true,
        ...
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxs(Space, { direction: "vertical", size: "large", style: { width: "100%" }, children: [
            /* @__PURE__ */ jsxs("div", { style: { textAlign: "center" }, children: [
              ...
              /* @__PURE__ */ jsx(Typography.Text, { type: "secondary", children: _38("Sign in to your account") })
            ] }),
            error && /* @__PURE__ */ jsx(
              Alert,
              {
