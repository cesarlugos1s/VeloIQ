...
import { DynamicList } from "@juicemantics/veloiq-ui";
...
export const CustomTaskList: React.FC = () => {
    return (
        <>
            ...
            <div style={{
                ...
                pointerEvents: "none",
                userSelect: "none",
            }}>⚙ Custom Task List</div>
            {/* ...to here. */}
            <DynamicList
                model={model}
                allModels={allModels}
                // Customize: add filter={{}}, listViewType="gallery", extraHeaderButtons={...}, etc.
            />
        </>
    );
};
